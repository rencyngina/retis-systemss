      ...
      <div className="min-h-screen flex flex-col mt-">
        ...
        <div className="w-full min-h-[50vh] flex flex-col lg:flex-row  bg-[#ffe55c] items-center justify-between px-6 xl:px-12 py-12 gap-8">
          ...
          <div className="lg:w-1/2 flex justify-center">
            <div className={`w-full max-w-md overflow-hidden ${styles.maskImage}`}>
              <img src="/image/map2.jpg" alt="Map Location" className="w-full h-auto object-cover rounded-lg shadow-md" />
            </div>
          </div>
        </div>
        ...
        <div className="w-full flex justify-center -mt-24">
          <div className="bg-white/80 sha w-full max-w-5xl flex flex-col md:flex-row items-stretch overflow-hidden">
            ...
            <div className="w-full md:w-2/3 p-6 flex flex-col justify-center">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-700 text-sm font-semibold">First Name</label>
                    <input type="text" placeholder="First name" className="w-full border p-2 rounded focus:ring-2 focus:ring-green-800 focus:outline-none" />
                  </div>
                  <div>
                    <label className="block text-gray-700 text-sm font-semibold">Last Name</label>
                    <input type="text" placeholder="Last name" className="w-full border p-2 rounded focus:ring-2 focus:ring-green-800 focus:outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-gray-700 text-sm font-semibold">Email</label>
                  <input type="email" placeholder="Enter your email" className="w-full border p-2 rounded focus:ring-2 focus:ring-green-800 focus:outline-none" />
                </div>
                <div>
                  <label className="block text-gray-700 text-sm font-semibold">Phone Number</label>
                  <input type="text" placeholder="Enter phone number" className="w-full border p-2 rounded focus:ring-2 focus:ring-green-800 focus:outline-none" />
                </div>
                <div>
                  <label className="block text-gray-700 text-sm font-semibold">Message</label>
                  <textarea placeholder="Write your message here" rows="3" className="w-full border p-2 rounded focus:ring-2 focus:ring-green-800 focus:outline-none"></textarea>
                </div>
                <button type="submit" className="w-32 bg-gray-800 text-white py-2 rounded font-semibold hover:bg-[#2e2827] flex justify-center items-center focus:ring-2 focus:ring-gray-600">
                  Send
                </button>
              </form>
            </div>
            ...
            <div className="relative w-full md:w-1/3 flex flex-col justify-center items-center">
              <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/image/call.jpeg')" }}>
              </div>
        ...
        <div className="w-full flex flex-col items-center text-center mt-24 px-6 mb-9">
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Find Us Here</h1>
          <div className="w-48 h-1 bg-[#A65A2A] mb-4"></div>
          <p className="text-lg text-gray-600 mb-6 font-montserrat">
            We are located at 5th Avenue Office Suite, 4th Floor, Suite 4 – 15, Off Ngong Road
          </p>
