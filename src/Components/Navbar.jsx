    ...
    <nav className="bg-[#ffdf33]/80 top-0 w-full z-50 ">
      <div className="container mx-auto px-4 flex justify-between items-center h-16 left-10">
        ...
        <div className="hidden md:flex space-x-8 ml-14 items-center font-bold"> 
          <Link href="/" className="text-[#8b3f91]  text-lg font-serif transition-transform active:scale-90 hover:scale-110">
            Home
          </Link>
          <Link href="/about" className="text-[#8b3f91]  text-lg font-serif transition-transform active:scale-90 hover:scale-110">
            About
          </Link>
          {/* Services Dropdown */}
          <div 
            ...
            {dropdownOpen && (
              <div className="absolute z-10 bg-[#FFE55C]/90 divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                <ul className="py-2 text-sm text-gray-700" aria-labelledby="dropdownHoverButton">
                  <li>
                    <Link href="/services/software-dev" className="block px-4 py-2 text-[#8B3F91] hover:text-white">Software Developing</Link>
                  </li>
                  <li>
                    <Link href="/services/cyber-security" className="block px-4 py-2 text-[#8B3F91] hover:text-white">Cyber Security</Link>
                  </li>
                  <li>
                    <Link href="/services/digital-marketing" className="block px-4 py-2 text-[#8B3F91] hover:text-white">Digital Marketing</Link>
                  </li>
                  <li>
                    <Link href="/services/training" className="block px-4 py-2 text-[#8B3F91] hover:text-white">Training</Link>
                  </li>
                </ul>
              </div>
            )}
          ...
          <Link href="/pricings" className="text-[#8b3f91]  text-lg font-serif transition-transform active:scale-90 hover:scale-110">
            Pricings
          </Link>
        </div>
        ...
        <div className="flex justify-center flex-grow">
          <Link href="/">
            <Image src="/image/logo.svg" alt="Retis Systems Logo" width={90} height={50} />
          </Link>
        </div>
