    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] space-y-10 px-4 md:px-10 lg:px-20 bg-gradient-to-b from-[#07294C] to-[#084D92]">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-10 space-y-10 sm:space-y-0 sm:justify-center">
        ...
        <div className="w-full max-w-md sm:w-72 lg:w-80 p-6 bg-[#FFEC80] rounded-lg shadow-lg text-center">
          ...
          <h1
            className={`text-xl sm:text-2xl font-semibold mb-4 ${lora.className}`}
          >
            Integrated Digital Strategy
          </h1>
          <p className="text-sm sm:text-base  text-[#07294C] leading-relaxed font-serif">
            At Retis Systems, we offer a comprehensive approach to digital
            strategy by seamlessly integrating digital marketing, cybersecurity,
            software development, and training. Our holistic solutions ensure
            that every aspect of your business's digital presence is optimized
            for success.
          </p>
        </div>
        ...
        <div className="w-full max-w-md sm:w-72 lg:w-80 p-6 bg-[#FFEC80] rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm sm:text-base text-[#07294C] leading-relaxed font-serif">
            Partnering with Retis Systems means gaining access to a team of
            experts who are committed to driving innovation and providing
            valuable insights. Our forward-thinking approach ensures your
            business stays ahead in the competitive digital economy.
          </p>
        </div>
        ...
        <div className="w-full max-w-md sm:w-72 lg:w-80 p-6 bg-[#FFEC80] rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm sm:text-base text-[#07294C] leading-relaxed font-serif">
            ...
            Retis Systems prioritizes your business's security. Our cutting-edge
            cybersecurity services protect your assets, allowing you to focus on
