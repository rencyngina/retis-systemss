        ...
        <div className="flex flex-col items-center justify-center lg:min-h-[90vh] min-h-[50vh] lg:p-4 p-8">
          ...
          <div className="flex justify-center gap-6 px-6 max-w-screen-xl -mt-8 flex-wrap">
            {plans.map((plan, index) => (
              <article
                key={index}
                className="relative w-[250px] h-[300px] rounded-[20px] bg-cover bg-center shadow-lg overflow-hidden group"
              ...
              >
                ...
                {/* Content */}
                <div className="absolute bottom-0 left-0 w-full h-1/2 group-hover:h-full transition-all duration-500 bg-black/80 text-white p-4 rounded-tl-[42px] overflow-hidden shadow-md">
